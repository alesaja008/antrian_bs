...
export default function HeaderHiq() {
  ...
  return (
    <div className="bg-background relative flex size-full items-center justify-center p-16 z-60">
      <GridPattern
        width={20}
        height={20}
        x={-1}
      ...
      />
      <header className={`fixed top-0 left-0 right-0 text-white z-50 rounded-b-4xl transition-all duration-300 ${scrolled ? "bg-white shadow-md py-5 px-5" : "py-7"}`}>
