    ...
    return (
        ...
        <section className="w-full bg-red-600 rounded-2xl p-6 flex items-center justify-between overflow-hidden relative">
            ...
            <div className="flex flex-col gap-3 z-10 max-w-xs">
                ...
                <p className="text-white text-xs">Kamu bisa mendapatkan aplikasi <span className="font-bold">Sobat Bintang</span> di</p>
                <div className="flex gap-3">
                    {/* App Store Button */}
                    <a
                        href="#"
                        className="flex items-center gap-2 bg-white text-black rounded-lg px-3 py-2 text-xs font-semibold hover:bg-gray-100 transition"
                    >
                ...
                <p className="text-white text-[10px]">Tinggal download, daftar, dan langsung nikmati keuntungannya</p>
            </div>
